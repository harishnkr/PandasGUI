...
PANDASGUI_ICON_PATH = str(files(__package__).joinpath("resources/images/icon.png"))
PANDASGUI_ICON_PATH_ICO = str(files(__package__).joinpath("resources/images/icon.ico"))
